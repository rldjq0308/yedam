				...
				<div class="col-xl-7 col-lg-8 col-md-7">
					...
					<div class="site-pagination" id="pagination">
						...
						<c:forEach var="num" begin="${pagingVO.startPage}"
							...
							<c:set var="pageLink"
								value="latestgames.do?pageNum=${num}&amount=${pagingVO.amount}" />
							<c:choose>
								<c:when test="${not empty param.key}">
					...
					<div id="stickySidebar">
						<div class="widget-item">
							<div class="categories-widget">
								...
								<ul id="key">
									<li><a href="latestgames.do?key=액션">액션</a></li>
									<li><a href="latestgames.do?key=어드벤처">어드벤처</a></li>
									<li><a href="latestgames.do?key=롤플레잉">롤플레잉</a></li>
									<li><a href="latestgames.do?key=스포츠">스포츠</a></li>
									<li><a href="latestgames.do?key=전략">전략</a></li>
								</ul>
							</div>
						</div>
						<div class="widget-item">
							<div class="categories-widget">
								...
								<ul id="val">
									<li><a href="latestgames.do?val=PC">PC</a></li>
									<li><a href="latestgames.do?val=Xbox">Xbox</a></li>
									<li><a href="latestgames.do?val=Play%20Station">Play
											Station</a></li>
									<li><a href="latestgames.do?val=Nintendo%20Switch">Nintendo
											Switch</a></li>
									<li><a href="latestgames.do?val=VR">VR</a></li>
								</ul>
							</div>
						</div>
					</div>
