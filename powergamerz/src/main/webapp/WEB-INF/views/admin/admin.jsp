				...
				<div class="tm-notification-items">
					<div class="media tm-notification-item">
						<div class="tm-gray-circle">
							<img src="adminmaster/img/notification-01.jpg" alt="Avatar Image"
					...
					<div class="media tm-notification-item">
						<div class="tm-gray-circle">
							<img src="adminmaster/img/notification-02.jpg" alt="Avatar Image"
								class="rounded-circle">
						</div>
						<div class="media-body">
							<p class="mb-2">
								<b>Oliver Too</b> and <b>6 others</b> sent you existing <a
									href="#" class="tm-notification-link">product updates</a>. Read
								more reports.
							</p>
							<span class="tm-small tm-text-color-secondary">6h ago.</span>
						</div>
					...
					<div class="media tm-notification-item">
						<div class="tm-gray-circle">
							<img src="adminmaster/img/notification-03.jpg" alt="Avatar Image"
								class="rounded-circle">
						</div>
						<div class="media-body">
							<p class="mb-2">
